...
data modify entity @s[nbt=!{Item:{tag:{RabbitLeap:1b}}}] Item.tag.Enchantments append value {}
data modify entity @s[nbt=!{Item:{tag:{RabbitLeap:1b}}}] Item.tag.display.Lore prepend value "[{\"text\":\"Rabbit Leap I\",\"italic\":false,\"color\":\"gray\"}]"
data modify entity @s[nbt=!{Item:{tag:{RabbitLeap:1b}}}] Item.tag.RabbitLeap set value 1b
...
tag @s remove rabbit_leap_i_charging