...
execute if predicate ce_rabbit_leap_ii:contains_enchantable if entity @s[scores={item_1=3,item_2=1},nbt={HandItems:[{tag:{RabbitLeap:1b}}]}] run function ce_rabbit_leap_ii:lock_frames
kill @s