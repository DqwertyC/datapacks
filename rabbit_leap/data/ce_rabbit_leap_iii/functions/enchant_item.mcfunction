...
# Will cause issues if other custom_enchants are added between Rabbit II and Rabbit III
data modify entity @s[nbt={Item:{tag:{RabbitLeap:2b}}}] Item.tag.display.Lore[0] set value "[{\"text\":\"Rabbit Leap III\",\"italic\":false,\"color\":\"gray\"}]"
data modify entity @s[nbt={Item:{tag:{RabbitLeap:2b}}}] Item.tag.RabbitLeap set value 3b
...
tag @s remove rabbit_leap_iii_charging