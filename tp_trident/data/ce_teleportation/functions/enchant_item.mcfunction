...
data modify entity @s[nbt=!{Item:{tag:{Teleportation:1b}}}] Item.tag.Enchantments append value {}
data modify entity @s[nbt=!{Item:{tag:{Teleportation:1b}}}] Item.tag.display.Lore prepend value "[{\"text\":\"Teleportation\",\"italic\":false,\"color\":\"gray\"}]"
data modify entity @s[nbt=!{Item:{tag:{Teleportation:1b}}}] Item.tag.Teleportation set value 1b
...
tag @s remove teleportation_charging